...
function OrderCard({ img,
    ...
    return (
        <Card className="roundedmd:max-w-4xl me-4 flex-col sm:flex-row md:flex-col lg:flex-row xl:flex-row  border-2 border-gray-300 shadow-none">
            <CardHeader
                shadow={false}
                floated={false}
                className="m-0 sm:w-2/6 md:w-full lg:w-2/6 xl:md:w-2/6 shrink-0 rounded-r-none"
            >
                <img
